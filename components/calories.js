      ...
      <div className="sm:flex sm:items-center pt-10">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Write the ammount of desire calories. You can also skip this step
          </p>
        </div>
            ...
            <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
              <table className="min-w-full divide-y divide-gray-300">
                ...
                <tbody className="bg-white">
                  {calories.map((calories, calorietIdx) => (
                    <tr
                      key={calories.ammount}
                      className={
                        calorietIdx % 2 === 0 ? undefined : "bg-gray-50"
                      }
                    >
                      ...
                      <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        ...
                        >
                          Edit
                          <span className="sr-only">, {calories.name}</span>
                        </a>
                      </td>
                    </tr>
                  ))}
